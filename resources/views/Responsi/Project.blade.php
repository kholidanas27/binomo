                  ...
                  <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                    <thead>
                      <tr role="row">
                        ...
                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1">NAMA PEGAWAI</th>
                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1">NAMA PERUSAHAAN</th>
                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1">PEKERJAAN</th>
                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1">PROJECT MULAI</th>
                         <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1">PROJECT SELESAI</th>
                    ...
                    <tbody>
                      ...
                      <tr role="row" class="add">
                        <td>{{ $p->idProject }}</td>
                        <td>
                          @foreach($p->pegawai as $pgw)
                          {{ $pgw->namaPegawai }}
                          @endforeach
                        </td>
                        <td>
                          @foreach($p->perusahaan as $psn)
                          {{ $psn->namaPerusahaan }}
                          @endforeach
                        </td>
                        <td>
                        ...
                        <td>{{ $p->mulaiProject }}</td>
                        <td>{{ $p->akhirProject }}</td>
                      </tr>
                      @endforeach
                    </tbody>
                  </table>    
